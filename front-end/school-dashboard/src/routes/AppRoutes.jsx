    ...
    <>
      ...
      <Routes>
        ...
        <Route path="/" element={<ProtectedGuard><DashboardLayout /></ProtectedGuard>}>
          ...
          <Route path="parents" element={<RoleGuard moduleKey="parents"><ParentsPage /></RoleGuard>} />
          <Route path="academics" element={<RoleGuard moduleKey="academics"><AcademicsPage /></RoleGuard>} />
          <Route path="attendance" element={<RoleGuard moduleKey="attendance"><AttendancePage /></RoleGuard>} />
