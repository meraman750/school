...
const MODULE_ACCESS = {
  overview: [ROLES.SUPER_ADMIN, ROLES.ADMIN, ROLES.TEACHER, ROLES.ACCOUNTANT],
  students: [ROLES.SUPER_ADMIN, ROLES.ADMIN, ROLES.TEACHER],
  teachers: [ROLES.SUPER_ADMIN, ROLES.ADMIN],
  parents: [ROLES.SUPER_ADMIN, ROLES.ADMIN, ROLES.TEACHER],
  academics: [ROLES.SUPER_ADMIN, ROLES.ADMIN, ROLES.TEACHER],
  attendance: [ROLES.SUPER_ADMIN, ROLES.ADMIN, ROLES.TEACHER],
  ...
  transport: [ROLES.SUPER_ADMIN, ROLES.ADMIN],
  inventory: [ROLES.SUPER_ADMIN, ROLES.ADMIN],
  hr: [ROLES.SUPER_ADMIN, ROLES.ADMIN],
  communication: [ROLES.SUPER_ADMIN, ROLES.ADMIN, ROLES.TEACHER],
  documents: [ROLES.SUPER_ADMIN, ROLES.ADMIN, ROLES.TEACHER],
  reports: [ROLES.SUPER_ADMIN, ROLES.ADMIN, ROLES.ACCOUNTANT],
